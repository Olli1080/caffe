...
#list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${GLOG_INCLUDE_DIRS})
list(APPEND Caffe_LINKER_LIBS PUBLIC glog::glog)

# ---[ Google-gflags
find_package(gflags CONFIG REQUIRED)
#include("cmake/External/gflags.cmake")
#list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${GFLAGS_INCLUDE_DIRS})
...
if(USE_HDF5)
  ...
  #list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${HDF5_INCLUDE_DIRS})
  #include_directories(SYSTEM ${HDF5_INCLUDE_DIRS} ${HDF5_HL_INCLUDE_DIR})
  list(APPEND Caffe_LINKER_LIBS PRIVATE ${HDF5_LIBRARIES} ${HDF5_HL_LIBRARIES})
...
if(USE_LMDB)
  ...
  list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${LMDB_INCLUDE_DIR})
  list(APPEND Caffe_LINKER_LIBS PRIVATE ${LMDB_LIBRARIES})
...
if(USE_LEVELDB)
  ...
  list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${LevelDB_INCLUDES})
  list(APPEND Caffe_LINKER_LIBS PRIVATE ${LevelDB_LIBRARIES})
...
if (CPU_ONLY)
  ...
  if (BUILD_SHARED_LIBS)
    list(APPEND Caffe_LINKER_LIBS PUBLIC CUDA::cudart CUDA::cublas CUDA::curand CUDA::cublasLt)
  else()
    list(APPEND Caffe_LINKER_LIBS PUBLIC CUDA::cudart_static CUDA::cublas_static CUDA::curand_static CUDA::cublasLt_static)
  endif()
  list(APPEND Caffe_LINKER_LIBS PUBLIC CuDNN::CuDNN)
...
if(USE_NCCL)
  ...
  list(APPEND Caffe_LINKER_LIBS PRIVATE ${NCCL_LIBRARIES})
...
if(USE_OPENCV)
  ...
  #list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${OpenCV_INCLUDE_DIRS})
...
if(NOT APPLE)
  ...
  if(BLAS STREQUAL "Open" OR BLAS STREQUAL "open")
    ...
    list(APPEND Caffe_LINKER_LIBS PUBLIC BLAS::BLAS)
  elseif(BLAS STREQUAL "MKL" OR BLAS STREQUAL "mkl")
    set(BLA_VENDOR Intel10_64lp)
    find_package(BLAS REQUIRED)
    #list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${MKL_INCLUDE_DIR})
    list(APPEND Caffe_LINKER_LIBS PUBLIC BLAS::BLAS)
    list(APPEND Caffe_DEFINITIONS PUBLIC -DUSE_MKL)
  endif()
elseif(APPLE)
  find_package(vecLib REQUIRED)
  list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${vecLib_INCLUDE_DIR})
  list(APPEND Caffe_LINKER_LIBS PRIVATE ${vecLib_LINKER_LIBS})
