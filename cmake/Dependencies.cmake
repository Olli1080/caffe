...
if (CPU_ONLY)
  ...
  if (BUILD_SHARED_LIBS)
    list(APPEND Caffe_LINKER_LIBS PUBLIC CUDA::cudart CUDA::cublas CUDA::curand)
  else()
    list(APPEND Caffe_LINKER_LIBS PUBLIC CUDA::cudart_static CUDA::cublas_static CUDA::curand_static)
  endif()
