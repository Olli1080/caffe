...
function(caffe_print_configuration_summary)
  ...
  if(CUDAToolkit_FOUND)
    ...
    caffe_status("  GPU arch(s)       :   ${CUDA_ARCHITECTURES}")
    if(USE_CUDNN)
  ...
  if(BUILD_python)
    if(Python3_FOUND)
      caffe_status("Python:")
      caffe_status("  Interpreter       :" "${Python3_EXECUTABLE} (ver. ${Python3_VERSION})")
      caffe_status("  Libraries         :" "${Python3_LIBRARIES}")
      caffe_status("  NumPy             :" "${Python3_NumPy_INCLUDE_DIRS} (ver ${Python3_NumPy_VERSION})")
      caffe_status("")
    endif()
    if(Python2_FOUND)
      caffe_status("Python:")
      caffe_status("  Interpreter       :" "${Python2_EXECUTABLE} (ver. ${Python2_VERSION})")
      caffe_status("  Libraries         :" "${Python2_LIBRARIES}")
      caffe_status("  NumPy             :" "${Python2_NumPy_INCLUDE_DIRS} (ver ${Python2_NumPy_VERSION})")
      caffe_status("")
    endif()
  endif()
  if(BUILD_matlab)
