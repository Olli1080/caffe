...
void CuDNNSigmoidLayer<Dtype>::LayerSetUp(const std::vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void CuDNNSigmoidLayer<Dtype>::Reshape(const std::vector<Blob<Dtype>*>& bottom,
      const std::vector<Blob<Dtype>*>& top) {
...
#else
template <typename Dtype>
void CuDNNSigmoidLayer<Dtype>::Forward_gpu(const std::vector<Blob<Dtype>*>& bottom,
    const std::vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void CuDNNSigmoidLayer<Dtype>::Backward_gpu(const std::vector<Blob<Dtype>*>& top,
