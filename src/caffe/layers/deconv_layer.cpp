...
template <typename Dtype>
void DeconvolutionLayer<Dtype>::Forward_cpu(const std::vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DeconvolutionLayer<Dtype>::Backward_cpu(const std::vector<Blob<Dtype>*>& top,
...
#else
template <typename Dtype>
void DeconvolutionLayer<Dtype>::Forward_gpu(const std::vector<Blob<Dtype>*>& bottom,
    const std::vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void DeconvolutionLayer<Dtype>::Backward_gpu(const std::vector<Blob<Dtype>*>& top,
    const std::vector<bool>& propagate_down, const std::vector<Blob<Dtype>*>& bottom) {
    const Dtype* weight = this->blobs_[0]->gpu_data();
