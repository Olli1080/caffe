...
void MVNLayer<Dtype>::Reshape(const std::vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void MVNLayer<Dtype>::Forward_cpu(const std::vector<Blob<Dtype>*>& bottom,
    const std::vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void MVNLayer<Dtype>::Backward_cpu(const std::vector<Blob<Dtype>*>& top,
...
#else
template <typename Dtype>
void MVNLayer<Dtype>::Forward_gpu(const std::vector<Blob<Dtype>*>& bottom,
    const std::vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void MVNLayer<Dtype>::Backward_gpu(const std::vector<Blob<Dtype>*>& top,
    const std::vector<bool>& propagate_down,
    const std::vector<Blob<Dtype>*>& bottom) {
